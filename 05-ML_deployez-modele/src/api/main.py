...
app = FastAPI(
    title="API de Prédiction de Départ d'Employés",
    description="Prédit la probabilité de départ des employés.",
    version="1.0.0"
)
...
# test with curl -H "Authorization: Bearer YourBearer" http://server_url:server_port/test-auth
